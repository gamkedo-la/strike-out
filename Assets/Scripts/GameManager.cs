...
*/
    ...
    public void Save()
    {
        ...
        PlayerPrefs.SetFloat("StarterFast", StarterFast);
        PlayerPrefs.SetFloat("StarterSlid", StarterSlid);
        PlayerPrefs.SetFloat("StarterCurve", StarterCurve);
        PlayerPrefs.SetFloat("StarterChange", StarterChange);
        PlayerPrefs.SetFloat("StarterAgil", StarterAgil);

        PlayerPrefs.SetFloat("MiddleFast", MiddleFast);
        PlayerPrefs.SetFloat("MiddleSlid", MiddleSlid);
        PlayerPrefs.SetFloat("MiddleCurve", MiddleCurve);
        PlayerPrefs.SetFloat("MiddleChange", MiddleChange);
        PlayerPrefs.SetFloat("MiddleAgil", MiddleAgil);

        PlayerPrefs.SetFloat("SetUpFast", SetUpFast);
        PlayerPrefs.SetFloat("SetUpSlid", SetUpSlid);
        PlayerPrefs.SetFloat("SetUpCurve", SetUpCurve);
        PlayerPrefs.SetFloat("SetUpChange", SetUpChange);
        PlayerPrefs.SetFloat("SetUpAgil", SetUpAgil);

        PlayerPrefs.SetFloat("CloserFast", CloserFast);
        PlayerPrefs.SetFloat("CloserSlid", CloserSlid);
        PlayerPrefs.SetFloat("CloserCurve", CloserCurve);
        PlayerPrefs.SetFloat("CloserChange", CloserChange);
        PlayerPrefs.SetFloat("CloserAgil", CloserAgil);

        PlayerPrefs.SetFloat("StarterLevel", StarterLevel);
        PlayerPrefs.SetFloat("MRLevel", MRLevel);
        PlayerPrefs.SetFloat("SetUpLevel", SetUpLevel);
        PlayerPrefs.SetFloat("CloserLevel", CloserLevel);

        PlayerPrefs.SetFloat("StarterMorale", StarterMorale);
        PlayerPrefs.SetFloat("StarterEnergy", StarterEnergy);
        PlayerPrefs.SetFloat("StarterMoraleMax", StarterMoraleMax);
        PlayerPrefs.SetFloat("StarterEnergyMax", StarterEnergyMax);

        PlayerPrefs.SetFloat("MidRelivMorale", MidRelivMorale);
        PlayerPrefs.SetFloat("MidRelivEnergy", MidRelivEnergy);
        PlayerPrefs.SetFloat("MidRelivMoraleMax", MidRelivMoraleMax);
        PlayerPrefs.SetFloat("MidRelievEnergyMax", MidRelievEnergyMax);

        PlayerPrefs.SetFloat("SetUpMorale", SetUpMorale);
        PlayerPrefs.SetFloat("SetUpEnergy", SetUpEnergy);
        PlayerPrefs.SetFloat("SetUpMoraleMax", SetUpMoraleMax);
        PlayerPrefs.SetFloat("SetUpEnergyMax", SetUpEnergyMax);

        PlayerPrefs.SetFloat("CloserMorale", CloserMorale);
        PlayerPrefs.SetFloat("CloserEnergy", CloserEnergy);
        PlayerPrefs.SetFloat("CloserMoraleMax", CloserMoraleMax);
        PlayerPrefs.SetFloat("CloserEnergyMax", CloserEnergyMax);

        //convert this to the bool once it is loaded
        PlayerPrefs.SetFloat("Minor1Value", m1v);
        PlayerPrefs.SetFloat("Minor2Value", m2v);
        PlayerPrefs.SetFloat("Minor3Value", m3v);
        PlayerPrefs.SetFloat("Minor4Value", m4v);
        PlayerPrefs.SetFloat("Minor5Value", m5v);
        PlayerPrefs.SetFloat("Minor6Value", m6v);
        PlayerPrefs.SetFloat("Minor7Value", m7v);
        PlayerPrefs.SetFloat("Minor8Value", m8v);

        PlayerPrefs.SetFloat("Major1Value", M1v);
        PlayerPrefs.SetFloat("Major2Value", M2v);
        PlayerPrefs.SetFloat("Major3Value", M3v);
        PlayerPrefs.SetFloat("Major4Value", M4v);
        PlayerPrefs.SetFloat("Major5Value", M5v);
        PlayerPrefs.SetFloat("Major6Value", M6v);
        PlayerPrefs.SetFloat("Major7Value", M7v);
        PlayerPrefs.SetFloat("Major8Value", M8v);

        PlayerPrefs.SetFloat("MidRelivMorale", StarterExp);
        PlayerPrefs.SetFloat("MidRelivEnergy", MRExp);
        PlayerPrefs.SetFloat("MidRelivMoraleMax", SetUpExp);
        PlayerPrefs.SetFloat("MidRelievEnergyMax", CloserExp);

        PlayerPrefs.SetFloat("SetUpMorale", StarterTargetExp);
        PlayerPrefs.SetFloat("SetUpEnergy", MRTargetExp);
        PlayerPrefs.SetFloat("SetUpMoraleMax", SetupTargetExp);
        PlayerPrefs.SetFloat("SetUpEnergyMax", CloserTargetExp);
